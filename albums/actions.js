...
export function getList() {
    const request = axios.get(`${process.env.REACT_APP_API_HOST}/albums`)
    return {
        type: 'ALBUMS_FETCHED',
        payload: request
    }
...
function submit(values, method) {
    return dispatch => {
        ...
        axios[method](`${process.env.REACT_APP_API_HOST}/albums/${id}`, filteredValues)
        .then(resp => {
